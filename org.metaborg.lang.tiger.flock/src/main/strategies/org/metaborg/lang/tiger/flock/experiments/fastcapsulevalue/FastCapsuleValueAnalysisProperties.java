...
public class FastCapsuleValueAnalysisProperties {
	...
	static class ConstPropTop extends ConstProp {
		...
		public IStrategoTerm toTerm() {
			ITermFactory factory = Flock.instance.factory;
			IStrategoTerm r = factory.makeAppl(factory.makeConstructor("Top", 0), new IStrategoTerm[] {}, null);
			return r;
		}
	...
	static class ConstPropBottom extends ConstProp {
		...
		public IStrategoTerm toTerm() {
			ITermFactory factory = Flock.instance.factory;
			IStrategoTerm r = factory.makeAppl(factory.makeConstructor("Bottom", 0), new IStrategoTerm[] {}, null);
			return r;
		}
