...
class Value implements FlockValueLattice {
  ...
  public static Value bottom( ) {
                                  ConstProp tmp23 = (ConstProp ) new ConstProp (new StrategoAppl (new StrategoConstructor ("Bottom",0),new IStrategoTerm[]{ },null));
                                  return new Value (tmp23);
                                }
  public static Value top( ) {
                               ConstProp tmp24 = (ConstProp ) new ConstProp (new StrategoAppl (new StrategoConstructor ("Top",0),new IStrategoTerm[]{ },null));
                               return new Value (tmp24);
                             }
  @Override public FlockLattice lub(FlockLattice other) {
                                                          ConstProp usrl = ((Value ) this).value;
                                                          ConstProp usrr = ((Value ) other).value;
                                                          IStrategoTerm term1 = Helpers. toTerm(new StrategoTuple (new IStrategoTerm[]{Helpers. toTerm(usrl),Helpers. toTerm(usrr)},null));
                                                          Object result3 = null;
                                                          if(TermUtils. isTuple(term1) && (TermUtils. isAppl(Helpers. at(term1, 0)) && (M. appl(Helpers. at(term1, 0)). getName( ). equals("Top") && Helpers. at(term1, 0). getSubtermCount( ) == 0))) {
                                                                                                                                                                                                                                                         result3 = new ConstProp (new StrategoAppl (new StrategoConstructor ("Top",0),new IStrategoTerm[]{ },null));
                                                                                                                                                                                                                                                       }
                                                          if(TermUtils. isTuple(term1) && (TermUtils. isAppl(Helpers. at(term1, 1)) && (M. appl(Helpers. at(term1, 1)). getName( ). equals("Top") && Helpers. at(term1, 1). getSubtermCount( ) == 0))) {
                                                                                                                                                                                                                                                         result3 = new ConstProp (new StrategoAppl (new StrategoConstructor ("Top",0),new IStrategoTerm[]{ },null));
                                                                                                                                                                                                                                                       }
                                                          if(TermUtils. isTuple(term1) && (TermUtils. isAppl(Helpers. at(term1, 0)) && (M. appl(Helpers. at(term1, 0)). getName( ). equals("Const") && (Helpers. at(term1, 0). getSubtermCount( ) == 1 && (TermUtils. isAppl(Helpers. at(term1, 1)) && (M. appl(Helpers. at(term1, 1)). getName( ). equals("Const") && Helpers. at(term1, 1). getSubtermCount( ) == 1)))))) {
                                                                                                                                                                                                                                                                                                                                                                                                                              IStrategoTerm usri = Helpers. at(Helpers. at(term1, 0), 0);
                                                                                                                                                                                                                                                                                                                                                                                                                              IStrategoTerm usrj = Helpers. at(Helpers. at(term1, 1), 0);
                                                                                                                                                                                                                                                                                                                                                                                                                              result3 = (boolean) usri. equals(usrj) ? new ConstProp (new StrategoAppl (new StrategoConstructor ("Const",1),new IStrategoTerm[]{Helpers. toTerm(usri)},null)) : new ConstProp (new StrategoAppl (new StrategoConstructor ("Top",0),new IStrategoTerm[]{ },null));
                                                                                                                                                                                                                                                                                                                                                                                                                            }
                                                          if(TermUtils. isTuple(term1) && (TermUtils. isAppl(Helpers. at(term1, 1)) && (M. appl(Helpers. at(term1, 1)). getName( ). equals("Bottom") && Helpers. at(term1, 1). getSubtermCount( ) == 0))) {
                                                                                                                                                                                                                                                            result3 = usrl;
                                                                                                                                                                                                                                                          }
                                                          if(TermUtils. isTuple(term1) && (TermUtils. isAppl(Helpers. at(term1, 0)) && (M. appl(Helpers. at(term1, 0)). getName( ). equals("Bottom") && Helpers. at(term1, 0). getSubtermCount( ) == 0))) {
                                                                                                                                                                                                                                                            result3 = usrr;
                                                                                                                                                                                                                                                          }
                                                          if(result3 == null) {
                                                                                throw new RuntimeException ("Could not match term");
                                                                              }
                                                          ConstProp tmp25 = (ConstProp ) result3;
                                                          return new Value (tmp25);
                                                        }
}
...
class TransferFunction0 extends TransferFunction {
  @Override public FlockLattice eval(Node node) {
                                                  IStrategoTerm term = node.term;
                                                  Node prev = node;
                                                  SimpleMap tmp16 = (SimpleMap ) UserFunctions. values_f(prev);
                                                  return tmp16;
                                                }
}
class TransferFunction1 extends TransferFunction {
  @Override public FlockLattice eval(Node node) {
                                                  ...
                                                  for( Object o : ((Map ) ((FlockLattice ) UserFunctions. values_f(prev)). value( )). entrySet( )) {
                                                                                                                                                     ...
                                                                                                                                                     if(!usrk. equals(usrn)) {
                                                                                                                                                                               result4. put(usrk, usrv);
                                                                                                                                                                             }
                                                                                                                                                   }
                                                  Map tmp20 = (Map ) result4;
                                                  Map tmp21 = (Map ) MapUtils. create(usrn, new Value (new ConstProp (new StrategoAppl (new StrategoConstructor ("Top",0),new IStrategoTerm[]{ },null))));
                                                  Map tmp22 = (Map ) new SimpleMap (MapUtils. union(tmp20, tmp21));
                                                  Map tmp15 = (Map ) tmp22;
                                                  return new SimpleMap (tmp15);
                                                }
}
class TransferFunction2 extends TransferFunction {
  @Override public FlockLattice eval(Node node) {
                                                  ...
                                                  for( Object o : ((Map ) ((FlockLattice ) UserFunctions. values_f(prev)). value( )). entrySet( )) {
                                                                                                                                                     ...
                                                                                                                                                     Object usrv = entry. getValue( );
                                                                                                                                                     if(!usrk. equals(usrn)) {
                                                                                                                                                                               result5. put(usrk, usrv);
                                                                                                                                                                             }
                                                                                                                                                   }
                                                  Map tmp17 = (Map ) result5;
                                                  Map tmp18 = (Map ) MapUtils. create(usrn, new Value (new ConstProp (new StrategoAppl (new StrategoConstructor ("Const",1),new IStrategoTerm[]{Helpers. toTerm(usri)},null))));
                                                  Map tmp19 = (Map ) new SimpleMap (MapUtils. union(tmp17, tmp18));
                                                  Map tmp14 = (Map ) tmp19;
                                                  return new SimpleMap (tmp14);
                                                }
}
class TransferFunction3 extends TransferFunction {
  @Override public FlockLattice eval(Node node) {
                                                  IStrategoTerm term = node.term;
                                                  SimpleMap tmp13 = (SimpleMap ) SimpleMap. bottom( );
                                                  return tmp13;
                                                }
}
class UserFunctions {
