...
class Value implements FlockValueLattice {
  ...
  public static Value bottom( ) {
                                  ConstProp tmp107 = (ConstProp ) new ConstProp (new StrategoAppl (new StrategoConstructor ("Bottom",0),new IStrategoTerm[]{ },null));
                                  return new Value (tmp107);
                                }
  public static Value top( ) {
                               ConstProp tmp108 = (ConstProp ) new ConstProp (new StrategoAppl (new StrategoConstructor ("Top",0),new IStrategoTerm[]{ },null));
                               return new Value (tmp108);
                             }
  @Override public FlockLattice lub(FlockLattice other) {
                                                          ConstProp usrl = ((Value ) this).value;
                                                          ConstProp usrr = ((Value ) other).value;
                                                          IStrategoTerm term11 = Helpers. toTerm(new StrategoTuple (new IStrategoTerm[]{Helpers. toTerm(usrl),Helpers. toTerm(usrr)},null));
                                                          Object result176 = null;
                                                          if(TermUtils. isTuple(term11) && (TermUtils. isAppl(Helpers. at(term11, 0)) && (M. appl(Helpers. at(term11, 0)). getName( ). equals("Top") && Helpers. at(term11, 0). getSubtermCount( ) == 0))) {
                                                                                                                                                                                                                                                             result176 = new ConstProp (new StrategoAppl (new StrategoConstructor ("Top",0),new IStrategoTerm[]{ },null));
                                                                                                                                                                                                                                                           }
                                                          if(TermUtils. isTuple(term11) && (TermUtils. isAppl(Helpers. at(term11, 1)) && (M. appl(Helpers. at(term11, 1)). getName( ). equals("Top") && Helpers. at(term11, 1). getSubtermCount( ) == 0))) {
                                                                                                                                                                                                                                                             result176 = new ConstProp (new StrategoAppl (new StrategoConstructor ("Top",0),new IStrategoTerm[]{ },null));
                                                                                                                                                                                                                                                           }
                                                          if(TermUtils. isTuple(term11) && (TermUtils. isAppl(Helpers. at(term11, 0)) && (M. appl(Helpers. at(term11, 0)). getName( ). equals("Const") && (Helpers. at(term11, 0). getSubtermCount( ) == 1 && (TermUtils. isAppl(Helpers. at(term11, 1)) && (M. appl(Helpers. at(term11, 1)). getName( ). equals("Const") && Helpers. at(term11, 1). getSubtermCount( ) == 1)))))) {
                                                                                                                                                                                                                                                                                                                                                                                                                                     IStrategoTerm usri = Helpers. at(Helpers. at(term11, 0), 0);
                                                                                                                                                                                                                                                                                                                                                                                                                                     IStrategoTerm usrj = Helpers. at(Helpers. at(term11, 1), 0);
                                                                                                                                                                                                                                                                                                                                                                                                                                     result176 = (boolean) usri. equals(usrj) ? new ConstProp (new StrategoAppl (new StrategoConstructor ("Const",1),new IStrategoTerm[]{Helpers. toTerm(usri)},null)) : new ConstProp (new StrategoAppl (new StrategoConstructor ("Top",0),new IStrategoTerm[]{ },null));
                                                                                                                                                                                                                                                                                                                                                                                                                                   }
                                                          if(TermUtils. isTuple(term11) && (TermUtils. isAppl(Helpers. at(term11, 1)) && (M. appl(Helpers. at(term11, 1)). getName( ). equals("Bottom") && Helpers. at(term11, 1). getSubtermCount( ) == 0))) {
                                                                                                                                                                                                                                                                result176 = usrl;
                                                                                                                                                                                                                                                              }
                                                          if(TermUtils. isTuple(term11) && (TermUtils. isAppl(Helpers. at(term11, 0)) && (M. appl(Helpers. at(term11, 0)). getName( ). equals("Bottom") && Helpers. at(term11, 0). getSubtermCount( ) == 0))) {
                                                                                                                                                                                                                                                                result176 = usrr;
                                                                                                                                                                                                                                                              }
                                                          if(result176 == null) {
...
class TransferFunction1 extends TransferFunction {
  @Override public FlockLattice eval(Node node) {
                                                  ...
                                                  Map tmp105 = (Map ) MapUtils. create(usrn, new Value (new ConstProp (new StrategoAppl (new StrategoConstructor ("Top",0),new IStrategoTerm[]{ },null))));
                                                  Map tmp106 = (Map ) new HashMap (MapUtils. union(tmp104, tmp105));
                                                  Map tmp90 = (Map ) tmp106;
                                                  return new SimpleMap (tmp90);
                                                }
}
class TransferFunction2 extends TransferFunction {
  @Override public FlockLattice eval(Node node) {
                                                  ...
                                                  Map tmp102 = (Map ) MapUtils. create(usrn, new Value (new ConstProp (new StrategoAppl (new StrategoConstructor ("Top",0),new IStrategoTerm[]{ },null))));
                                                  Map tmp103 = (Map ) new HashMap (MapUtils. union(tmp101, tmp102));
                                                  Map tmp89 = (Map ) tmp103;
                                                  return new SimpleMap (tmp89);
                                                }
}
class TransferFunction3 extends TransferFunction {
  @Override public FlockLattice eval(Node node) {
                                                  ...
                                                  Map tmp99 = (Map ) MapUtils. create(usrn, new Value (new ConstProp (new StrategoAppl (new StrategoConstructor ("Const",1),new IStrategoTerm[]{Helpers. toTerm(usri)},null))));
                                                  Map tmp100 = (Map ) new HashMap (MapUtils. union(tmp98, tmp99));
                                                  Map tmp86 = (Map ) tmp100;
                                                  return new SimpleMap (tmp86);
                                                }
}
class TransferFunction4 extends TransferFunction {
  @Override public FlockLattice eval(Node node) {
                                                  ...
                                                  Map tmp96 = (Map ) MapUtils. create(usrn, new Value (new ConstProp (new StrategoAppl (new StrategoConstructor ("Top",0),new IStrategoTerm[]{ },null))));
                                                  Map tmp97 = (Map ) new HashMap (MapUtils. union(tmp95, tmp96));
                                                  Map tmp83 = (Map ) tmp97;
                                                  return new SimpleMap (tmp83);
                                                }
}
class TransferFunction5 extends TransferFunction {
  @Override public FlockLattice eval(Node node) {
                                                  ...
                                                  Map tmp93 = (Map ) MapUtils. create(usrn, new Value (new ConstProp (new StrategoAppl (new StrategoConstructor ("Const",1),new IStrategoTerm[]{Helpers. toTerm(usri)},null))));
                                                  Map tmp94 = (Map ) new HashMap (MapUtils. union(tmp92, tmp93));
                                                  Map tmp80 = (Map ) tmp94;
                                                  return new SimpleMap (tmp80);
                                                }
}
