...
public class FlowAnalysisStrategies {
  public static class get_expressions_0_0 extends Strategy {
    ...
    @Override public IStrategoTerm invoke(Context context, IStrategoTerm current) {
                                                                                    ...
                                                                                    IStrategoList result = factory. makeList(((Map<IStrategoTerm, IStrategoTerm> ) node. getProperty("expressions").lattice. value( )). entrySet( ). stream( ). map(n -> factory. makeTuple(Helpers. toTerm(n. getKey( )), Helpers. toTerm(n. getValue( )))). collect(Collectors. toList( )));
                                                                                    return result;
                                                                                  }
  }
  public static class get_expressions_0_1 extends Strategy {
    public static get_expressions_0_1 instance = new get_expressions_0_1 ( );
    @Override public IStrategoTerm invoke(Context context,IStrategoTerm current, IStrategoTerm key) {
                                                                                                      ...
                                                                                                      Flock.instance. analysisWithName("expressions"). performDataAnalysis(Flock.instance.graph, Flock.instance.graph_scss, node);
                                                                                                      Map<IStrategoTerm, Object> values = (Map<IStrategoTerm, Object> ) node. getProperty("expressions").lattice. value( );
